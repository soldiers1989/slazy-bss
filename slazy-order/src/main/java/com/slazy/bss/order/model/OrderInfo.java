...
public class OrderInfo {
    ...
    public Date getReceiverStartime() {
        return receiverStartime;
    }

    public void setReceiverStartime(Date receiverStartime) {
        this.receiverStartime = receiverStartime;
    }

    public Date getReceiverEndtime() {
        return receiverEndtime;
    }

    public void setReceiverEndtime(Date receiverEndtime) {
    ...
    public Date getPayStartime() {
        return payStartime;
    }

    public void setPayStartime(Date payStartime) {
